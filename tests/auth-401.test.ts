...
// Mirror runtime-broker's server.ts publicRoutes config. Drift in either
...
async function buildAuthClosedApp() {
  ...
  app.post('/api/v1/sessions', async () => ({ id: 's1' }));
  return app;
}

describe('runtime-broker — fail-closed auth wiring', () => {
